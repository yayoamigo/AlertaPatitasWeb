...
const Home = () => {
  ...
  return (
    <>
        ...
        <div className={styles.textcontainer}>
          <div className="flex flex-col items-center justify-center h-[20rem]  ">
            ...
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4">
              <button 
                className="w-40 h-10 bg-white dark:border-black text-black border-solid border-2 border-black"
              ...
              <button 
                className="w-40 h-10 bg-black text-white border border-black"
                onClick={handleStoreClick}
              >
      ...
      {showToast && (
        <Toast 
          message="Pronto podrás descargar la app" 
